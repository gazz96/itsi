		...
		<div class="container">
				...
				<div class="prodi-grid prodi-grid-arc">
					<?php $pi = 0; while ( $prodi_q->have_posts() ) : $prodi_q->the_post();
						...
						<a href="<?php the_permalink(); ?>" class="pc rv d<?php echo esc_attr( $pi % 4 ); ?>">
							<div class="pc-icon"><i class="bi bi-mortarboard" aria-hidden="true"></i></div>
			...
			<?php else : ?>
				...
				<div class="prodi-grid">
					<a href="#" class="pc rv"><div class="pc-icon"><i class="bi bi-tree" aria-hidden="true"></i></div><span class="pc-deg">S1 · Agribisnis</span><h3 class="pc-name">Agribisnis</h3><p class="pc-desc">Manajemen rantai pasok, pemasaran, dan kewirausahaan agribisnis sawit berkelanjutan.</p><div class="pc-meta"><span class="pc-acc">Akreditasi A</span><span class="pc-link">Pelajari →</span></div></a>
					<a href="#" class="pc rv d1"><div class="pc-icon"><i class="bi bi-shield-check" aria-hidden="true"></i></div><span class="pc-deg">S1 · Proteksi Tanaman</span><h3 class="pc-name">Proteksi Tanaman</h3><p class="pc-desc">Pengendalian hama, penyakit, dan teknik perlindungan tanaman perkebunan modern.</p><div class="pc-meta"><span class="pc-acc">Akreditasi A</span><span class="pc-link">Pelajari →</span></div></a>
					<a href="#" class="pc rv d2"><div class="pc-icon"><i class="bi bi-laptop" aria-hidden="true"></i></div><span class="pc-deg">S1 · Sistem &amp; TI</span><h3 class="pc-name">Sistem &amp; Teknologi Informasi</h3><p class="pc-desc">Pemanfaatan IT untuk automasi industri, IoT perkebunan, dan transformasi digital.</p><div class="pc-meta"><span class="pc-acc">Akreditasi Unggul</span><span class="pc-link">Pelajari →</span></div></a>
					<a href="#" class="pc rv d3"><div class="pc-icon"><i class="bi bi-eyedropper" aria-hidden="true"></i></div><span class="pc-deg">S1 · Teknik Kimia</span><h3 class="pc-name">Teknik Kimia</h3><p class="pc-desc">Pengolahan hasil sawit, biorefineri, dan teknologi proses kimia industri.</p><div class="pc-meta"><span class="pc-acc">Akreditasi A</span><span class="pc-link">Pelajari →</span></div></a>
					<a href="#" class="pc rv"><div class="pc-icon"><i class="bi bi-gear-wide-connected" aria-hidden="true"></i></div><span class="pc-deg">D4 · Vokasi</span><h3 class="pc-name">T. Pengolahan Hasil Perkebunan</h3><p class="pc-desc">Pengolahan CPO, PKO, dan produk turunan dengan standar industri internasional.</p><div class="pc-meta"><span class="pc-acc">Akreditasi Unggul</span><span class="pc-link">Pelajari →</span></div></a>
					<a href="#" class="pc rv d1"><div class="pc-icon"><i class="bi bi-tree" aria-hidden="true"></i></div><span class="pc-deg">D4 · Vokasi</span><h3 class="pc-name">Budidaya Perkebunan</h3><p class="pc-desc">Praktik budidaya kelapa sawit presisi dan berkelanjutan dari hulu ke hilir.</p><div class="pc-meta"><span class="pc-acc">Akreditasi A</span><span class="pc-link">Pelajari →</span></div></a>
				</div>
			<?php endif; ?>
		</div>
	</section>
